...
NutSorter::ForceMeasurement::ForceMeasurement(Carousel* carousel, CoterminalAngle start_angle, CoterminalAngle end_angle)
: _sensor(_pin)
{
...
void NutSorter::ForceMeasurement::setup()
{
  _sensor.setup();
...
void NutSorter::ForceMeasurement::tick()
{
	if (!_is_setup)
	  return;
...
void NutSorter::ForceMeasurement::_finish_with_slot(boolean has_heavy_object)
{
...
boolean NutSorter::ForceMeasurement::_is_slot_over_sensor()
{
