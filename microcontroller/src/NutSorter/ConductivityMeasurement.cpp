...
int NutSorter::ConductivityMeasurement::_sensor_pins[] = {5, 6, 7};
...
NutSorter::ConductivityMeasurement::ConductivityMeasurement(Carousel* carousel, CoterminalAngle start_angle, CoterminalAngle end_angle)
...
boolean NutSorter::ConductivityMeasurement::setup()
{
  if (!_sensor.setup())
    return false;
...
void NutSorter::ConductivityMeasurement::tick()
{
	if (!_is_setup)
	  return;
...
void NutSorter::ConductivityMeasurement::_finish_with_slot(boolean has_conductive_object)
{
...
boolean NutSorter::ConductivityMeasurement::_is_slot_over_sensor()
{
