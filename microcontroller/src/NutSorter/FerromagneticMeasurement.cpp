...
NutSorter::FerromagneticMeasurement::FerromagneticMeasurement(Carousel* carousel, CoterminalAngle start_angle, CoterminalAngle end_angle)
{
...
boolean NutSorter::FerromagneticMeasurement::setup()
{
  if (!_sensor.setup())
    return false;
...
void NutSorter::FerromagneticMeasurement::tick()
{
	if (!_is_setup)
	  return;
...
void NutSorter::FerromagneticMeasurement::_finish_with_slot(boolean has_ferromagnetic_object)
{
...
boolean NutSorter::FerromagneticMeasurement::_is_slot_over_sensor()
{
