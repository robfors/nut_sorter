...
NutSorter::Interpreter::Interpreter(Carousel* carousel, Chute* chute, CoterminalAngle start_angle)
{
  _chute = chute;
  _carousel = carousel;
  _next_slot = NULL;
...
void NutSorter::Interpreter::setup()
{
...
void NutSorter::Interpreter::tick()
{
	if (!_is_setup)
	  return;
...
void NutSorter::Interpreter::_process_slot(Slot* slot)
{
  Serial.println("slot: ");
