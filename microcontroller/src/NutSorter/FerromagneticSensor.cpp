...
NutSorter::FerromagneticSensor::FerromagneticSensor()
...
int NutSorter::FerromagneticSensor::field()
{
	return (int)_compass.readNormalize().ZAxis;
}


boolean NutSorter::FerromagneticSensor::is_ferromagnetic_material_present()
{
  if (!_is_setup)
    return false;
...
boolean NutSorter::FerromagneticSensor::setup()
{
  if (!_compass.begin())
    return false;
...
void NutSorter::FerromagneticSensor::tick()
{
	if (!_is_setup)
	  return;
...
boolean NutSorter::FerromagneticSensor::_is_ferromagnetic_material_present()
{
