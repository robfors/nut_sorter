...
NutSorter::Profile::Profile()
{
  clear();
}


void NutSorter::Profile::add_sample(unsigned int distance, unsigned int sample)
{
...
unsigned int NutSorter::Profile::average_sample()
{
